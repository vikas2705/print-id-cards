export default function IdCardTemplate({ student }) {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ position: "absolute", top: "67px", left: "45px" }}
        data-position
      >
        <img
      ...
      <div
        style={{ position: "absolute", top: "165px", left: "45px" }}
        data-position
      >
        <img
      ...
      >
        <b>
          : 31/05/
          {student?.year_of_enrolment && student?.Programme
            ? student.year_of_enrolment +
              student.programme.minimum_duration_year
            : ""}
        </b>
      </div>

      <div
        style={{ position: "absolute", top: "180px", left: "275px" }}
        data-position
      ></div>
      ...
      >
        ...
        {student?.permanent_state || ""}, {student?.permanent_state || ""}-
      ...
      >
        ...
        <div>Shri Lal Bahadur Shastri National Sanskrit University</div>
        <div>
          <u>B-4, Qutub Institutional Area, New Delhi,Delhi, India-110016</u>
        </div>
      </div>
